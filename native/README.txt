...
Install in Ubuntu/Mint:
    $ sudo apt-get install gcc make automake yasm openjdk-7-jre openjdk-7-jdk gcc-mingw-w64

Install in openSUSE:
    $ sudo zypper install gcc make automake yasm java-1_7_0-openjdk java-1_7_0-openjdk-devel
