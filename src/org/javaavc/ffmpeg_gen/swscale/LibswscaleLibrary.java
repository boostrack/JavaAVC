package org.javaavc.ffmpeg_gen.swscale;
...
public interface LibswscaleLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #sws_getContext(int, int, int, int, int, int, int, org.javaavc.ffmpeg_gen.swscale.SwsFilter, org.javaavc.ffmpeg_gen.swscale.SwsFilter, java.nio.DoubleBuffer)} and {@link #sws_getContext(int, int, int, int, int, int, int, org.javaavc.ffmpeg_gen.swscale.SwsFilter, org.javaavc.ffmpeg_gen.swscale.SwsFilter, com.sun.jna.ptr.DoubleByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #sws_scale(org.javaavc.ffmpeg_gen.swscale.LibswscaleLibrary.SwsContext, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, int, int, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer)} and {@link #sws_scale(org.javaavc.ffmpeg_gen.swscale.LibswscaleLibrary.SwsContext, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, int, int, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #sws_getColorspaceDetails(org.javaavc.ffmpeg_gen.swscale.LibswscaleLibrary.SwsContext, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, java.nio.IntBuffer, java.nio.IntBuffer, java.nio.IntBuffer)} and {@link #sws_getColorspaceDetails(org.javaavc.ffmpeg_gen.swscale.LibswscaleLibrary.SwsContext, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #sws_getCachedContext(org.javaavc.ffmpeg_gen.swscale.LibswscaleLibrary.SwsContext, int, int, int, int, int, int, int, org.javaavc.ffmpeg_gen.swscale.SwsFilter, org.javaavc.ffmpeg_gen.swscale.SwsFilter, java.nio.DoubleBuffer)} and {@link #sws_getCachedContext(org.javaavc.ffmpeg_gen.swscale.LibswscaleLibrary.SwsContext, int, int, int, int, int, int, int, org.javaavc.ffmpeg_gen.swscale.SwsFilter, org.javaavc.ffmpeg_gen.swscale.SwsFilter, com.sun.jna.ptr.DoubleByReference)} instead
	 */
	@Deprecated 
