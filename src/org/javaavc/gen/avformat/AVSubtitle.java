...
public class AVSubtitle extends Structure {
	...
	public org.javaavc.gen.avformat.AVSubtitleRect.ByReference[] rects;
	 ...
	 */
	public AVSubtitle(short format, int start_display_time, int end_display_time, int num_rects, org.javaavc.gen.avformat.AVSubtitleRect.ByReference rects[], long pts) {
		super();
		this.format = format;
