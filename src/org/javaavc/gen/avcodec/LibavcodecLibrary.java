...
public interface LibavcodecLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #av_rescale_delta(org.javaavc.gen.avcodec.AVRational.ByValue, long, org.javaavc.gen.avcodec.AVRational.ByValue, int, java.nio.LongBuffer, org.javaavc.gen.avcodec.AVRational.ByValue)} and {@link #av_rescale_delta(org.javaavc.gen.avcodec.AVRational.ByValue, long, org.javaavc.gen.avcodec.AVRational.ByValue, int, com.sun.jna.ptr.LongByReference, org.javaavc.gen.avcodec.AVRational.ByValue)} instead
	 */
	@Deprecated 
	...
	double av_ext2dbl(org.javaavc.gen.avcodec.AVExtFloat.ByValue ext);
	...
	org.javaavc.gen.avcodec.AVExtFloat.ByValue av_dbl2ext(double d);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_vlog(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.gen.avcodec.LibavcodecLibrary.va_list)} and {@link #av_vlog(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.gen.avcodec.LibavcodecLibrary.va_list)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_log_default_callback(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.gen.avcodec.LibavcodecLibrary.va_list)} and {@link #av_log_default_callback(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.gen.avcodec.LibavcodecLibrary.va_list)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_log_format_line(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.gen.avcodec.LibavcodecLibrary.va_list, java.nio.ByteBuffer, int, java.nio.IntBuffer)} and {@link #av_log_format_line(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.gen.avcodec.LibavcodecLibrary.va_list, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_buffer_create(java.nio.ByteBuffer, int, org.javaavc.gen.avcodec.LibavcodecLibrary.av_buffer_create_free_callback, com.sun.jna.Pointer, int)} and {@link #av_buffer_create(com.sun.jna.Pointer, int, org.javaavc.gen.avcodec.LibavcodecLibrary.av_buffer_create_free_callback, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_unref(org.javaavc.gen.avcodec.AVBufferRef.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_make_writable(org.javaavc.gen.avcodec.AVBufferRef.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_realloc(org.javaavc.gen.avcodec.AVBufferRef.ByReference[], int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_dict_get(com.sun.jna.ptr.PointerByReference, java.lang.String, org.javaavc.gen.avcodec.AVDictionaryEntry, int)} and {@link #av_dict_get(com.sun.jna.ptr.PointerByReference, com.sun.jna.Pointer, org.javaavc.gen.avcodec.AVDictionaryEntry, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_frame_get_qp_table(org.javaavc.gen.avcodec.AVFrame, java.nio.IntBuffer, java.nio.IntBuffer)} and {@link #av_frame_get_qp_table(org.javaavc.gen.avcodec.AVFrame, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_frame_free(org.javaavc.gen.avcodec.AVFrame.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_packet_from_data(org.javaavc.gen.avcodec.AVPacket, java.nio.ByteBuffer, int)} and {@link #av_packet_from_data(org.javaavc.gen.avcodec.AVPacket, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
