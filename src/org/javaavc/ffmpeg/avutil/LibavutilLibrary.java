...
public interface LibavutilLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #av_rescale_delta(org.javaavc.ffmpeg.avutil.AVRational.ByValue, long, org.javaavc.ffmpeg.avutil.AVRational.ByValue, int, java.nio.LongBuffer, org.javaavc.ffmpeg.avutil.AVRational.ByValue)} and {@link #av_rescale_delta(org.javaavc.ffmpeg.avutil.AVRational.ByValue, long, org.javaavc.ffmpeg.avutil.AVRational.ByValue, int, com.sun.jna.ptr.LongByReference, org.javaavc.ffmpeg.avutil.AVRational.ByValue)} instead
	 */
	@Deprecated 
	...
	double av_ext2dbl(org.javaavc.ffmpeg.avutil.AVExtFloat.ByValue ext);
	...
	org.javaavc.ffmpeg.avutil.AVExtFloat.ByValue av_dbl2ext(double d);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_vlog(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avutil.LibavutilLibrary.va_list)} and {@link #av_vlog(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avutil.LibavutilLibrary.va_list)} instead
	 */
	@Deprecated 
	void av_vlog(Pointer avcl, int level, Pointer fmt, LibavutilLibrary.va_list va_list1);
	 ...
	 * @deprecated use the safer methods {@link #av_log_default_callback(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avutil.LibavutilLibrary.va_list)} and {@link #av_log_default_callback(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avutil.LibavutilLibrary.va_list)} instead
	 */
	@Deprecated 
	void av_log_default_callback(Pointer ptr, int level, Pointer fmt, LibavutilLibrary.va_list vl);
	 ...
	 * @deprecated use the safer methods {@link #av_log_format_line(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avutil.LibavutilLibrary.va_list, java.nio.ByteBuffer, int, java.nio.IntBuffer)} and {@link #av_log_format_line(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avutil.LibavutilLibrary.va_list, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	void av_log_format_line(Pointer ptr, int level, Pointer fmt, LibavutilLibrary.va_list vl, Pointer line, int line_size, IntByReference print_prefix);
	/**
	 * Format a line of log the same way as the default callback.<br>
	 * @param line          buffer to receive the formated line<br>
	 * @param line_size     size of the buffer<br>
