...
public interface LibavformatLibrary extends Library {
     ...
     */
    int av_get_packet(LibavformatLibrary.AVIOContext s, LibavformatLibrary.AVPacket pkt, int size);
    /**
     ...
     */
    int av_append_packet(LibavformatLibrary.AVIOContext s, LibavformatLibrary.AVPacket pkt, int size);
    /** Original signature : <code>AVRational av_stream_get_r_frame_rate(const AVStream*)</code> */
    LibavformatLibrary.AVRational av_stream_get_r_frame_rate(AVStream s);
    /** Original signature : <code>void av_stream_set_r_frame_rate(AVStream*, AVRational)</code> */
    void av_stream_set_r_frame_rate(AVStream s, LibavformatLibrary.AVRational r);
    /**
     ...
     * @deprecated use the safer methods {@link #av_probe_input_buffer(org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVIOContext, org.javaavc.ffmpeg.avformat.AVInputFormat.ByReference[], java.lang.String, com.sun.jna.Pointer, int, int)} and {@link #av_probe_input_buffer(org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVIOContext, org.javaavc.ffmpeg.avformat.AVInputFormat.ByReference[], com.sun.jna.Pointer, com.sun.jna.Pointer, int, int)} instead
     */
    @Deprecated
    int av_probe_input_buffer(LibavformatLibrary.AVIOContext pb, PointerByReference fmt, Pointer filename, Pointer logctx, int offset, int max_probe_size);
    /**
     * Probe a bytestream to determine the input format. Each time a probe returns<br>
     * with a score that is too low, the probe buffer size is increased and another<br>
     * attempt is made. When the maximum probe size is reached, the input format<br>
     ...
     * @deprecated use the safer methods {@link #avformat_open_input(org.javaavc.ffmpeg.avformat.AVFormatContext.ByReference[], java.lang.String, org.javaavc.ffmpeg.avformat.AVInputFormat, org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVDictionary[])} and {@link #avformat_open_input(org.javaavc.ffmpeg.avformat.AVFormatContext.ByReference[], com.sun.jna.Pointer, org.javaavc.ffmpeg.avformat.AVInputFormat, org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVDictionary[])} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer method {@link #avformat_find_stream_info(org.javaavc.ffmpeg.avformat.AVFormatContext, org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVDictionary[])} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer method {@link #av_find_best_stream(org.javaavc.ffmpeg.avformat.AVFormatContext, int, int, int, org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVCodec[], int)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer method {@link #avformat_write_header(org.javaavc.ffmpeg.avformat.AVFormatContext, org.javaavc.ffmpeg.avformat.LibavformatLibrary.AVDictionary[])} instead
     */
    @Deprecated
     ...
     */
    LibavformatLibrary.AVRational av_guess_frame_rate(AVFormatContext ctx, AVStream stream, LibavformatLibrary.AVFrame frame);
    /**
