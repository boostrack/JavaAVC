 ...
 *
 * <P>
 * New fields can be added to the end with minor version bumps. Removal, reordering and changes to existing fields
 * require a major version bump. <CODE>sizeof(AVIOContext)</CODE> must not be used outside <CODE>libav*</CODE>.
 * </P>
 *
 * <P>
 * None of the function pointers in AVIOContext should be called directly, they should only be set by the client
 * application when implementing custom I/O. Normally these are set to the function pointers specified in
 * <CODE>avio_alloc_context()</CODE>.
 * </P>
 *
...
public class AVIOContext extends Structure {
    ...
    protected List<?> getFieldOrder() {
        return Arrays.asList("av_class", "buffer", "buffer_size", "buf_ptr", "buf_end", "opaque", "read_packet",
            "write_packet", "seek", "pos", "must_flush", "eof_reached", "write_flag", "max_packet_size", "checksum",
            "checksum_ptr", "update_checksum", "error", "read_pause", "read_seek", "seekable", "maxsize", "direct",
            "bytes_read", "seek_count", "writeout_count");
    }
