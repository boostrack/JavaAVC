...
public interface LibavdeviceLibrary extends Library {
	...
	public static interface AVPixelFormat {
		 ...
		 */
		public static final int PIX_FMT_NONE = (int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE;
		/** < planar YUV 4:2:0, 12bpp, (1 Cr & Cb sample per 2x2 Y samples) */
		public static final int PIX_FMT_YUV420P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 1);
		/** < packed YUV 4:2:2, 16bpp, Y0 Cb Y1 Cr */
		public static final int PIX_FMT_YUYV422 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 2);
		/** < packed RGB 8:8:8, 24bpp, RGBRGB... */
		public static final int PIX_FMT_RGB24 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 3);
		/** < packed RGB 8:8:8, 24bpp, BGRBGR... */
		public static final int PIX_FMT_BGR24 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 4);
		/** < planar YUV 4:2:2, 16bpp, (1 Cr & Cb sample per 2x1 Y samples) */
		public static final int PIX_FMT_YUV422P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 5);
		/** < planar YUV 4:4:4, 24bpp, (1 Cr & Cb sample per 1x1 Y samples) */
		public static final int PIX_FMT_YUV444P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 6);
		/** < planar YUV 4:1:0,  9bpp, (1 Cr & Cb sample per 4x4 Y samples) */
		public static final int PIX_FMT_YUV410P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 7);
		/** < planar YUV 4:1:1, 12bpp, (1 Cr & Cb sample per 4x1 Y samples) */
		public static final int PIX_FMT_YUV411P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 8);
		/** <        Y        ,  8bpp */
		public static final int PIX_FMT_GRAY8 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 9);
		/** <        Y        ,  1bpp, 0 is white, 1 is black, in each byte pixels are ordered from the msb to the lsb */
		public static final int PIX_FMT_MONOWHITE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 10);
		/** <        Y        ,  1bpp, 0 is black, 1 is white, in each byte pixels are ordered from the msb to the lsb */
		public static final int PIX_FMT_MONOBLACK = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 11);
		/** < 8 bit with PIX_FMT_RGB32 palette */
		public static final int PIX_FMT_PAL8 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 12);
		/** < planar YUV 4:2:0, 12bpp, full scale (JPEG), deprecated in favor of PIX_FMT_YUV420P and setting color_range */
		public static final int PIX_FMT_YUVJ420P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 13);
		/** < planar YUV 4:2:2, 16bpp, full scale (JPEG), deprecated in favor of PIX_FMT_YUV422P and setting color_range */
		public static final int PIX_FMT_YUVJ422P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 14);
		/** < planar YUV 4:4:4, 24bpp, full scale (JPEG), deprecated in favor of PIX_FMT_YUV444P and setting color_range */
		public static final int PIX_FMT_YUVJ444P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 15);
		/** < XVideo Motion Acceleration via common packet passing */
		public static final int PIX_FMT_XVMC_MPEG2_MC = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 16);
		public static final int PIX_FMT_XVMC_MPEG2_IDCT = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 17);
		/** < packed YUV 4:2:2, 16bpp, Cb Y0 Cr Y1 */
		public static final int PIX_FMT_UYVY422 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 18);
		/** < packed YUV 4:1:1, 12bpp, Cb Y0 Y1 Cr Y2 Y3 */
		public static final int PIX_FMT_UYYVYY411 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 19);
		/** < packed RGB 3:3:2,  8bpp, (msb)2B 3G 3R(lsb) */
		public static final int PIX_FMT_BGR8 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 20);
		/** < packed RGB 1:2:1 bitstream,  4bpp, (msb)1B 2G 1R(lsb), a byte contains two pixels, the first pixel in the byte is the one composed by the 4 msb bits */
		public static final int PIX_FMT_BGR4 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 21);
		/** < packed RGB 1:2:1,  8bpp, (msb)1B 2G 1R(lsb) */
		public static final int PIX_FMT_BGR4_BYTE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 22);
		/** < packed RGB 3:3:2,  8bpp, (msb)2R 3G 3B(lsb) */
		public static final int PIX_FMT_RGB8 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 23);
		/** < packed RGB 1:2:1 bitstream,  4bpp, (msb)1R 2G 1B(lsb), a byte contains two pixels, the first pixel in the byte is the one composed by the 4 msb bits */
		public static final int PIX_FMT_RGB4 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 24);
		/** < packed RGB 1:2:1,  8bpp, (msb)1R 2G 1B(lsb) */
		public static final int PIX_FMT_RGB4_BYTE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 25);
		/** < planar YUV 4:2:0, 12bpp, 1 plane for Y and 1 plane for the UV components, which are interleaved (first byte U and the following byte V) */
		public static final int PIX_FMT_NV12 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 26);
		/** < as above, but U and V bytes are swapped */
		public static final int PIX_FMT_NV21 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 27);
		/** < packed ARGB 8:8:8:8, 32bpp, ARGBARGB... */
		public static final int PIX_FMT_ARGB = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 28);
		/** < packed RGBA 8:8:8:8, 32bpp, RGBARGBA... */
		public static final int PIX_FMT_RGBA = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 29);
		/** < packed ABGR 8:8:8:8, 32bpp, ABGRABGR... */
		public static final int PIX_FMT_ABGR = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 30);
		/** < packed BGRA 8:8:8:8, 32bpp, BGRABGRA... */
		public static final int PIX_FMT_BGRA = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 31);
		/** <        Y        , 16bpp, big-endian */
		public static final int PIX_FMT_GRAY16BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 32);
		/** <        Y        , 16bpp, little-endian */
		public static final int PIX_FMT_GRAY16LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 33);
		/** < planar YUV 4:4:0 (1 Cr & Cb sample per 1x2 Y samples) */
		public static final int PIX_FMT_YUV440P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 34);
		/** < planar YUV 4:4:0 full scale (JPEG), deprecated in favor of PIX_FMT_YUV440P and setting color_range */
		public static final int PIX_FMT_YUVJ440P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 35);
		/** < planar YUV 4:2:0, 20bpp, (1 Cr & Cb sample per 2x2 Y & A samples) */
		public static final int PIX_FMT_YUVA420P = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 36);
		/** < H.264 HW decoding with VDPAU, data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VDPAU_H264 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 37);
		/** < MPEG-1 HW decoding with VDPAU, data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VDPAU_MPEG1 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 38);
		/** < MPEG-2 HW decoding with VDPAU, data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VDPAU_MPEG2 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 39);
		/** < WMV3 HW decoding with VDPAU, data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VDPAU_WMV3 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 40);
		/** < VC-1 HW decoding with VDPAU, data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VDPAU_VC1 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 41);
		/** < packed RGB 16:16:16, 48bpp, 16R, 16G, 16B, the 2-byte value for each R/G/B component is stored as big-endian */
		public static final int PIX_FMT_RGB48BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 42);
		/** < packed RGB 16:16:16, 48bpp, 16R, 16G, 16B, the 2-byte value for each R/G/B component is stored as little-endian */
		public static final int PIX_FMT_RGB48LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 43);
		/** < packed RGB 5:6:5, 16bpp, (msb)   5R 6G 5B(lsb), big-endian */
		public static final int PIX_FMT_RGB565BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 44);
		/** < packed RGB 5:6:5, 16bpp, (msb)   5R 6G 5B(lsb), little-endian */
		public static final int PIX_FMT_RGB565LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 45);
		/** < packed RGB 5:5:5, 16bpp, (msb)1A 5R 5G 5B(lsb), big-endian, most significant bit to 0 */
		public static final int PIX_FMT_RGB555BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 46);
		/** < packed RGB 5:5:5, 16bpp, (msb)1A 5R 5G 5B(lsb), little-endian, most significant bit to 0 */
		public static final int PIX_FMT_RGB555LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 47);
		/** < packed BGR 5:6:5, 16bpp, (msb)   5B 6G 5R(lsb), big-endian */
		public static final int PIX_FMT_BGR565BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 48);
		/** < packed BGR 5:6:5, 16bpp, (msb)   5B 6G 5R(lsb), little-endian */
		public static final int PIX_FMT_BGR565LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 49);
		/** < packed BGR 5:5:5, 16bpp, (msb)1A 5B 5G 5R(lsb), big-endian, most significant bit to 1 */
		public static final int PIX_FMT_BGR555BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 50);
		/** < packed BGR 5:5:5, 16bpp, (msb)1A 5B 5G 5R(lsb), little-endian, most significant bit to 1 */
		public static final int PIX_FMT_BGR555LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 51);
		/** < HW acceleration through VA API at motion compensation entry-point, Picture.data[3] contains a vaapi_render_state struct which contains macroblocks as well as various fields extracted from headers */
		public static final int PIX_FMT_VAAPI_MOCO = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 52);
		/** < HW acceleration through VA API at IDCT entry-point, Picture.data[3] contains a vaapi_render_state struct which contains fields extracted from headers */
		public static final int PIX_FMT_VAAPI_IDCT = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 53);
		/** < HW decoding through VA API, Picture.data[3] contains a vaapi_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VAAPI_VLD = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 54);
		/** < planar YUV 4:2:0, 24bpp, (1 Cr & Cb sample per 2x2 Y samples), little-endian */
		public static final int PIX_FMT_YUV420P16LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 55);
		/** < planar YUV 4:2:0, 24bpp, (1 Cr & Cb sample per 2x2 Y samples), big-endian */
		public static final int PIX_FMT_YUV420P16BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 56);
		/** < planar YUV 4:2:2, 32bpp, (1 Cr & Cb sample per 2x1 Y samples), little-endian */
		public static final int PIX_FMT_YUV422P16LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 57);
		/** < planar YUV 4:2:2, 32bpp, (1 Cr & Cb sample per 2x1 Y samples), big-endian */
		public static final int PIX_FMT_YUV422P16BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 58);
		/** < planar YUV 4:4:4, 48bpp, (1 Cr & Cb sample per 1x1 Y samples), little-endian */
		public static final int PIX_FMT_YUV444P16LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 59);
		/** < planar YUV 4:4:4, 48bpp, (1 Cr & Cb sample per 1x1 Y samples), big-endian */
		public static final int PIX_FMT_YUV444P16BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 60);
		/** < MPEG4 HW decoding with VDPAU, data[0] contains a vdpau_render_state struct which contains the bitstream of the slices as well as various fields extracted from headers */
		public static final int PIX_FMT_VDPAU_MPEG4 = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 61);
		/** < HW decoding through DXVA2, Picture.data[3] contains a LPDIRECT3DSURFACE9 pointer */
		public static final int PIX_FMT_DXVA2_VLD = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 62);
		/** < packed RGB 4:4:4, 16bpp, (msb)4A 4R 4G 4B(lsb), little-endian, most significant bits to 0 */
		public static final int PIX_FMT_RGB444LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 63);
		/** < packed RGB 4:4:4, 16bpp, (msb)4A 4R 4G 4B(lsb), big-endian, most significant bits to 0 */
		public static final int PIX_FMT_RGB444BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 64);
		/** < packed BGR 4:4:4, 16bpp, (msb)4A 4B 4G 4R(lsb), little-endian, most significant bits to 1 */
		public static final int PIX_FMT_BGR444LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 65);
		/** < packed BGR 4:4:4, 16bpp, (msb)4A 4B 4G 4R(lsb), big-endian, most significant bits to 1 */
		public static final int PIX_FMT_BGR444BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 66);
		/** < 8bit gray, 8bit alpha */
		public static final int PIX_FMT_GRAY8A = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 67);
		/** < packed RGB 16:16:16, 48bpp, 16B, 16G, 16R, the 2-byte value for each R/G/B component is stored as big-endian */
		public static final int PIX_FMT_BGR48BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 68);
		/** < packed RGB 16:16:16, 48bpp, 16B, 16G, 16R, the 2-byte value for each R/G/B component is stored as little-endian */
		public static final int PIX_FMT_BGR48LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 69);
		/**
		 * is better<br>
		 * < planar YUV 4:2:0, 13.5bpp, (1 Cr & Cb sample per 2x2 Y samples), big-endian
		 */
		public static final int PIX_FMT_YUV420P9BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 70);
		/** < planar YUV 4:2:0, 13.5bpp, (1 Cr & Cb sample per 2x2 Y samples), little-endian */
		public static final int PIX_FMT_YUV420P9LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 71);
		/** < planar YUV 4:2:0, 15bpp, (1 Cr & Cb sample per 2x2 Y samples), big-endian */
		public static final int PIX_FMT_YUV420P10BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 72);
		/** < planar YUV 4:2:0, 15bpp, (1 Cr & Cb sample per 2x2 Y samples), little-endian */
		public static final int PIX_FMT_YUV420P10LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 73);
		/** < planar YUV 4:2:2, 20bpp, (1 Cr & Cb sample per 2x1 Y samples), big-endian */
		public static final int PIX_FMT_YUV422P10BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 74);
		/** < planar YUV 4:2:2, 20bpp, (1 Cr & Cb sample per 2x1 Y samples), little-endian */
		public static final int PIX_FMT_YUV422P10LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 75);
		/** < planar YUV 4:4:4, 27bpp, (1 Cr & Cb sample per 1x1 Y samples), big-endian */
		public static final int PIX_FMT_YUV444P9BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 76);
		/** < planar YUV 4:4:4, 27bpp, (1 Cr & Cb sample per 1x1 Y samples), little-endian */
		public static final int PIX_FMT_YUV444P9LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 77);
		/** < planar YUV 4:4:4, 30bpp, (1 Cr & Cb sample per 1x1 Y samples), big-endian */
		public static final int PIX_FMT_YUV444P10BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 78);
		/** < planar YUV 4:4:4, 30bpp, (1 Cr & Cb sample per 1x1 Y samples), little-endian */
		public static final int PIX_FMT_YUV444P10LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 79);
		/** < planar YUV 4:2:2, 18bpp, (1 Cr & Cb sample per 2x1 Y samples), big-endian */
		public static final int PIX_FMT_YUV422P9BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 80);
		/** < planar YUV 4:2:2, 18bpp, (1 Cr & Cb sample per 2x1 Y samples), little-endian */
		public static final int PIX_FMT_YUV422P9LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 81);
		/** < hardware decoding through VDA */
		public static final int PIX_FMT_VDA_VLD = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 82);
		/** < planar GBR 4:4:4 24bpp */
		public static final int PIX_FMT_GBRP = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 83);
		/** < planar GBR 4:4:4 27bpp, big endian */
		public static final int PIX_FMT_GBRP9BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 84);
		/** < planar GBR 4:4:4 27bpp, little endian */
		public static final int PIX_FMT_GBRP9LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 85);
		/** < planar GBR 4:4:4 30bpp, big endian */
		public static final int PIX_FMT_GBRP10BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 86);
		/** < planar GBR 4:4:4 30bpp, little endian */
		public static final int PIX_FMT_GBRP10LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 87);
		/** < planar GBR 4:4:4 48bpp, big endian */
		public static final int PIX_FMT_GBRP16BE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 88);
		/** < planar GBR 4:4:4 48bpp, little endian */
		public static final int PIX_FMT_GBRP16LE = ((int)LibavdeviceLibrary.AVPixelFormat.AV_PIX_FMT_NONE + 89);
		/** < packed RGBA 16:16:16:16, 64bpp, 16R, 16G, 16B, 16A, the 2-byte value for each R/G/B/A component is stored as big-endian */
	...
	public static interface AVCodecID {
		...
		public static final int CODEC_ID_NONE = (int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE;
		/** video codecs */
		public static final int CODEC_ID_MPEG1VIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 1);
		/** < preferred ID for MPEG-1/2 video decoding */
		public static final int CODEC_ID_MPEG2VIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 2);
		public static final int CODEC_ID_MPEG2VIDEO_XVMC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 3);
		public static final int CODEC_ID_H261 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 4);
		public static final int CODEC_ID_H263 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 5);
		public static final int CODEC_ID_RV10 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 6);
		public static final int CODEC_ID_RV20 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 7);
		public static final int CODEC_ID_MJPEG = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 8);
		public static final int CODEC_ID_MJPEGB = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 9);
		public static final int CODEC_ID_LJPEG = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 10);
		public static final int CODEC_ID_SP5X = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 11);
		public static final int CODEC_ID_JPEGLS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 12);
		public static final int CODEC_ID_MPEG4 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 13);
		public static final int CODEC_ID_RAWVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 14);
		public static final int CODEC_ID_MSMPEG4V1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 15);
		public static final int CODEC_ID_MSMPEG4V2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 16);
		public static final int CODEC_ID_MSMPEG4V3 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 17);
		public static final int CODEC_ID_WMV1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 18);
		public static final int CODEC_ID_WMV2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 19);
		public static final int CODEC_ID_H263P = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 20);
		public static final int CODEC_ID_H263I = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 21);
		public static final int CODEC_ID_FLV1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 22);
		public static final int CODEC_ID_SVQ1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 23);
		public static final int CODEC_ID_SVQ3 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 24);
		public static final int CODEC_ID_DVVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 25);
		public static final int CODEC_ID_HUFFYUV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 26);
		public static final int CODEC_ID_CYUV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 27);
		public static final int CODEC_ID_H264 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 28);
		public static final int CODEC_ID_INDEO3 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 29);
		public static final int CODEC_ID_VP3 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 30);
		public static final int CODEC_ID_THEORA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 31);
		public static final int CODEC_ID_ASV1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 32);
		public static final int CODEC_ID_ASV2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 33);
		public static final int CODEC_ID_FFV1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 34);
		public static final int CODEC_ID_4XM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 35);
		public static final int CODEC_ID_VCR1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 36);
		public static final int CODEC_ID_CLJR = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 37);
		public static final int CODEC_ID_MDEC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 38);
		public static final int CODEC_ID_ROQ = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 39);
		public static final int CODEC_ID_INTERPLAY_VIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 40);
		public static final int CODEC_ID_XAN_WC3 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 41);
		public static final int CODEC_ID_XAN_WC4 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 42);
		public static final int CODEC_ID_RPZA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 43);
		public static final int CODEC_ID_CINEPAK = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 44);
		public static final int CODEC_ID_WS_VQA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 45);
		public static final int CODEC_ID_MSRLE = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 46);
		public static final int CODEC_ID_MSVIDEO1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 47);
		public static final int CODEC_ID_IDCIN = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 48);
		public static final int CODEC_ID_8BPS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 49);
		public static final int CODEC_ID_SMC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 50);
		public static final int CODEC_ID_FLIC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 51);
		public static final int CODEC_ID_TRUEMOTION1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 52);
		public static final int CODEC_ID_VMDVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 53);
		public static final int CODEC_ID_MSZH = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 54);
		public static final int CODEC_ID_ZLIB = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 55);
		public static final int CODEC_ID_QTRLE = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 56);
		public static final int CODEC_ID_TSCC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 57);
		public static final int CODEC_ID_ULTI = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 58);
		public static final int CODEC_ID_QDRAW = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 59);
		public static final int CODEC_ID_VIXL = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 60);
		public static final int CODEC_ID_QPEG = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 61);
		public static final int CODEC_ID_PNG = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 62);
		public static final int CODEC_ID_PPM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 63);
		public static final int CODEC_ID_PBM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 64);
		public static final int CODEC_ID_PGM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 65);
		public static final int CODEC_ID_PGMYUV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 66);
		public static final int CODEC_ID_PAM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 67);
		public static final int CODEC_ID_FFVHUFF = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 68);
		public static final int CODEC_ID_RV30 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 69);
		public static final int CODEC_ID_RV40 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 70);
		public static final int CODEC_ID_VC1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 71);
		public static final int CODEC_ID_WMV3 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 72);
		public static final int CODEC_ID_LOCO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 73);
		public static final int CODEC_ID_WNV1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 74);
		public static final int CODEC_ID_AASC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 75);
		public static final int CODEC_ID_INDEO2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 76);
		public static final int CODEC_ID_FRAPS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 77);
		public static final int CODEC_ID_TRUEMOTION2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 78);
		public static final int CODEC_ID_BMP = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 79);
		public static final int CODEC_ID_CSCD = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 80);
		public static final int CODEC_ID_MMVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 81);
		public static final int CODEC_ID_ZMBV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 82);
		public static final int CODEC_ID_AVS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 83);
		public static final int CODEC_ID_SMACKVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 84);
		public static final int CODEC_ID_NUV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 85);
		public static final int CODEC_ID_KMVC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 86);
		public static final int CODEC_ID_FLASHSV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 87);
		public static final int CODEC_ID_CAVS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 88);
		public static final int CODEC_ID_JPEG2000 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 89);
		public static final int CODEC_ID_VMNC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 90);
		public static final int CODEC_ID_VP5 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 91);
		public static final int CODEC_ID_VP6 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 92);
		public static final int CODEC_ID_VP6F = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 93);
		public static final int CODEC_ID_TARGA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 94);
		public static final int CODEC_ID_DSICINVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 95);
		public static final int CODEC_ID_TIERTEXSEQVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 96);
		public static final int CODEC_ID_TIFF = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 97);
		public static final int CODEC_ID_GIF = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 98);
		public static final int CODEC_ID_DXA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 99);
		public static final int CODEC_ID_DNXHD = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 100);
		public static final int CODEC_ID_THP = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 101);
		public static final int CODEC_ID_SGI = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 102);
		public static final int CODEC_ID_C93 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 103);
		public static final int CODEC_ID_BETHSOFTVID = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 104);
		public static final int CODEC_ID_PTX = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 105);
		public static final int CODEC_ID_TXD = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 106);
		public static final int CODEC_ID_VP6A = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 107);
		public static final int CODEC_ID_AMV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 108);
		public static final int CODEC_ID_VB = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 109);
		public static final int CODEC_ID_PCX = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 110);
		public static final int CODEC_ID_SUNRAST = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 111);
		public static final int CODEC_ID_INDEO4 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 112);
		public static final int CODEC_ID_INDEO5 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 113);
		public static final int CODEC_ID_MIMIC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 114);
		public static final int CODEC_ID_RL2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 115);
		public static final int CODEC_ID_ESCAPE124 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 116);
		public static final int CODEC_ID_DIRAC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 117);
		public static final int CODEC_ID_BFI = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 118);
		public static final int CODEC_ID_CMV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 119);
		public static final int CODEC_ID_MOTIONPIXELS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 120);
		public static final int CODEC_ID_TGV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 121);
		public static final int CODEC_ID_TGQ = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 122);
		public static final int CODEC_ID_TQI = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 123);
		public static final int CODEC_ID_AURA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 124);
		public static final int CODEC_ID_AURA2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 125);
		public static final int CODEC_ID_V210X = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 126);
		public static final int CODEC_ID_TMV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 127);
		public static final int CODEC_ID_V210 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 128);
		public static final int CODEC_ID_DPX = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 129);
		public static final int CODEC_ID_MAD = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 130);
		public static final int CODEC_ID_FRWU = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 131);
		public static final int CODEC_ID_FLASHSV2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 132);
		public static final int CODEC_ID_CDGRAPHICS = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 133);
		public static final int CODEC_ID_R210 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 134);
		public static final int CODEC_ID_ANM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 135);
		public static final int CODEC_ID_BINKVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 136);
		public static final int CODEC_ID_IFF_ILBM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 137);
		public static final int CODEC_ID_IFF_BYTERUN1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 138);
		public static final int CODEC_ID_KGV1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 139);
		public static final int CODEC_ID_YOP = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 140);
		public static final int CODEC_ID_VP8 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 141);
		public static final int CODEC_ID_PICTOR = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 142);
		public static final int CODEC_ID_ANSI = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 143);
		public static final int CODEC_ID_A64_MULTI = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 144);
		public static final int CODEC_ID_A64_MULTI5 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 145);
		public static final int CODEC_ID_R10K = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 146);
		public static final int CODEC_ID_MXPEG = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 147);
		public static final int CODEC_ID_LAGARITH = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 148);
		public static final int CODEC_ID_PRORES = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 149);
		public static final int CODEC_ID_JV = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 150);
		public static final int CODEC_ID_DFA = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 151);
		public static final int CODEC_ID_WMV3IMAGE = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 152);
		public static final int CODEC_ID_VC1IMAGE = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 153);
		public static final int CODEC_ID_UTVIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 154);
		public static final int CODEC_ID_BMV_VIDEO = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 155);
		public static final int CODEC_ID_VBLE = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 156);
		public static final int CODEC_ID_DXTORY = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 157);
		public static final int CODEC_ID_V410 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 158);
		public static final int CODEC_ID_XWD = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 159);
		public static final int CODEC_ID_CDXL = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 160);
		public static final int CODEC_ID_XBM = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 161);
		public static final int CODEC_ID_ZEROCODEC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 162);
		public static final int CODEC_ID_MSS1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 163);
		public static final int CODEC_ID_MSA1 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 164);
		public static final int CODEC_ID_TSCC2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 165);
		public static final int CODEC_ID_MTS2 = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 166);
		public static final int CODEC_ID_CLLC = ((int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_NONE + 167);
		...
		public static final int CODEC_ID_SNOW = (int)LibavdeviceLibrary.AVCodecID.AV_CODEC_ID_SNOW;
		/**
		 * various PCM "codecs"<br>
		 * < A dummy id pointing at the start of audio codecs
		 */
	...
	public static final int LIBAVDEVICE_BUILD = (55 << 16 | 3 << 8 | 100);
	...
	public static final int LIBAVDEVICE_VERSION_INT = (55 << 16 | 3 << 8 | 100);
	...
	public interface av_log_set_callback_arg1_callback extends Callback {
		void apply(Pointer voidPtr1, int int1, Pointer charPtr1, LibavdeviceLibrary.va_list va_list1);
	};
	 ...
	 * @deprecated use the safer methods {@link #av_strerror(int, java.nio.ByteBuffer, org.javaavc.NativeSize)} and {@link #av_strerror(int, com.sun.jna.Pointer, org.javaavc.NativeSize)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_dynarray2_add(com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, org.javaavc.NativeSize, java.nio.ByteBuffer)} and {@link #av_dynarray2_add(com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, org.javaavc.NativeSize, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_rescale_delta(org.javaavc.ffmpeg.avdevice.AVRational.ByValue, long, org.javaavc.ffmpeg.avdevice.AVRational.ByValue, int, java.nio.LongBuffer, org.javaavc.ffmpeg.avdevice.AVRational.ByValue)} and {@link #av_rescale_delta(org.javaavc.ffmpeg.avdevice.AVRational.ByValue, long, org.javaavc.ffmpeg.avdevice.AVRational.ByValue, int, com.sun.jna.ptr.LongByReference, org.javaavc.ffmpeg.avdevice.AVRational.ByValue)} instead
	 */
	@Deprecated 
	...
	double av_ext2dbl(org.javaavc.ffmpeg.avdevice.AVExtFloat.ByValue ext);
	...
	org.javaavc.ffmpeg.avdevice.AVExtFloat.ByValue av_dbl2ext(double d);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_vlog(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.va_list)} and {@link #av_vlog(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.va_list)} instead
	 */
	@Deprecated 
	void av_vlog(Pointer avcl, int level, Pointer fmt, LibavdeviceLibrary.va_list va_list1);
	/** Original signature : <code>void av_vlog(void*, int, const char*, va_list)</code> */
	void av_vlog(Pointer avcl, int level, String fmt, LibavdeviceLibrary.va_list va_list1);
	...
	void av_log_set_callback(LibavdeviceLibrary.av_log_set_callback_arg1_callback arg1);
	/**
	 * Original signature : <code>void av_log_default_callback(void*, int, const char*, va_list)</code><br>
	 * @deprecated use the safer methods {@link #av_log_default_callback(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.va_list)} and {@link #av_log_default_callback(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.va_list)} instead
	 */
	@Deprecated 
	void av_log_default_callback(Pointer ptr, int level, Pointer fmt, LibavdeviceLibrary.va_list vl);
	/** Original signature : <code>void av_log_default_callback(void*, int, const char*, va_list)</code> */
	void av_log_default_callback(Pointer ptr, int level, String fmt, LibavdeviceLibrary.va_list vl);
	 ...
	 * @deprecated use the safer methods {@link #av_log_format_line(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.va_list, java.nio.ByteBuffer, int, java.nio.IntBuffer)} and {@link #av_log_format_line(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.va_list, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	void av_log_format_line(Pointer ptr, int level, Pointer fmt, LibavdeviceLibrary.va_list vl, Pointer line, int line_size, IntByReference print_prefix);
	/**
	 * Format a line of log the same way as the default callback.<br>
	 * @param line          buffer to receive the formated line<br>
	 * @param line_size     size of the buffer<br>
	 ...
	 */
	void av_log_format_line(Pointer ptr, int level, String fmt, LibavdeviceLibrary.va_list vl, ByteBuffer line, int line_size, IntBuffer print_prefix);
	 ...
	 * @deprecated use the safer methods {@link #av_buffer_create(java.nio.ByteBuffer, int, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.av_buffer_create_free_callback, com.sun.jna.Pointer, int)} and {@link #av_buffer_create(com.sun.jna.Pointer, int, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.av_buffer_create_free_callback, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	AVBufferRef av_buffer_create(Pointer data, int size, LibavdeviceLibrary.av_buffer_create_free_callback free, Pointer opaque, int flags);
	/**
	 * Create an AVBuffer from an existing array.<br>
	 * * If this function is successful, data is owned by the AVBuffer. The caller may<br>
	 * only access data through the returned AVBufferRef and references derived from<br>
	 ...
	 */
	AVBufferRef av_buffer_create(ByteBuffer data, int size, LibavdeviceLibrary.av_buffer_create_free_callback free, Pointer opaque, int flags);
	/**
	 ...
	 * @deprecated use the safer method {@link #av_buffer_unref(org.javaavc.ffmpeg.avdevice.AVBufferRef.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_make_writable(org.javaavc.ffmpeg.avdevice.AVBufferRef.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_realloc(org.javaavc.ffmpeg.avdevice.AVBufferRef.ByReference[], int)} instead
	 */
	@Deprecated 
	 ...
	 */
	PointerByReference av_buffer_pool_init(int size, LibavdeviceLibrary.av_buffer_pool_init_alloc_callback alloc);
	/**
	 ...
	 */
	void av_bprint_channel_layout(LibavdeviceLibrary.AVBPrint bp, int nb_channels, long channel_layout);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_dict_get(com.sun.jna.ptr.PointerByReference, java.lang.String, org.javaavc.ffmpeg.avdevice.AVDictionaryEntry, int)} and {@link #av_dict_get(com.sun.jna.ptr.PointerByReference, com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.AVDictionaryEntry, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_frame_set_metadata(org.javaavc.ffmpeg.avdevice.AVFrame, com.sun.jna.ptr.PointerByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_frame_get_qp_table(org.javaavc.ffmpeg.avdevice.AVFrame, java.nio.IntBuffer, java.nio.IntBuffer)} and {@link #av_frame_get_qp_table(org.javaavc.ffmpeg.avdevice.AVFrame, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_frame_free(org.javaavc.ffmpeg.avdevice.AVFrame.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #avcodec_free_frame(org.javaavc.ffmpeg.avdevice.AVFrame.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_packet_from_data(org.javaavc.ffmpeg.avdevice.AVPacket, java.nio.ByteBuffer, int)} and {@link #av_packet_from_data(org.javaavc.ffmpeg.avdevice.AVPacket, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_packet_get_side_data(org.javaavc.ffmpeg.avdevice.AVPacket, int, java.nio.IntBuffer)} and {@link #av_packet_get_side_data(org.javaavc.ffmpeg.avdevice.AVPacket, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_align_dimensions(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.IntBuffer, java.nio.IntBuffer)} and {@link #avcodec_align_dimensions(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_align_dimensions2(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.IntBuffer, java.nio.IntBuffer, java.nio.IntBuffer)} and {@link #avcodec_align_dimensions2(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_decode_audio3(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.ShortBuffer, java.nio.IntBuffer, org.javaavc.ffmpeg.avdevice.AVPacket)} and {@link #avcodec_decode_audio3(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.ShortByReference, com.sun.jna.ptr.IntByReference, org.javaavc.ffmpeg.avdevice.AVPacket)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_decode_audio4(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVFrame, java.nio.IntBuffer, org.javaavc.ffmpeg.avdevice.AVPacket)} and {@link #avcodec_decode_audio4(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVFrame, com.sun.jna.ptr.IntByReference, org.javaavc.ffmpeg.avdevice.AVPacket)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_decode_video2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVFrame, java.nio.IntBuffer, org.javaavc.ffmpeg.avdevice.AVPacket)} and {@link #avcodec_decode_video2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVFrame, com.sun.jna.ptr.IntByReference, org.javaavc.ffmpeg.avdevice.AVPacket)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_decode_subtitle2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVSubtitle, java.nio.IntBuffer, org.javaavc.ffmpeg.avdevice.AVPacket)} and {@link #avcodec_decode_subtitle2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVSubtitle, com.sun.jna.ptr.IntByReference, org.javaavc.ffmpeg.avdevice.AVPacket)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_parser_parse2(org.javaavc.ffmpeg.avdevice.AVCodecParserContext, org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, java.nio.ByteBuffer, int, long, long, long)} and {@link #av_parser_parse2(org.javaavc.ffmpeg.avdevice.AVCodecParserContext, org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.Pointer, int, long, long, long)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_parser_change(org.javaavc.ffmpeg.avdevice.AVCodecParserContext, org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, java.nio.ByteBuffer, int, int)} and {@link #av_parser_change(org.javaavc.ffmpeg.avdevice.AVCodecParserContext, org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.Pointer, int, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_encode_audio(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.ByteBuffer, int, java.nio.ShortBuffer)} and {@link #avcodec_encode_audio(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.Pointer, int, com.sun.jna.ptr.ShortByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_encode_audio2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVPacket, org.javaavc.ffmpeg.avdevice.AVFrame, java.nio.IntBuffer)} and {@link #avcodec_encode_audio2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVPacket, org.javaavc.ffmpeg.avdevice.AVFrame, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_encode_video(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.ByteBuffer, int, org.javaavc.ffmpeg.avdevice.AVFrame)} and {@link #avcodec_encode_video(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.Pointer, int, org.javaavc.ffmpeg.avdevice.AVFrame)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_encode_video2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVPacket, org.javaavc.ffmpeg.avdevice.AVFrame, java.nio.IntBuffer)} and {@link #avcodec_encode_video2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.AVPacket, org.javaavc.ffmpeg.avdevice.AVFrame, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_encode_subtitle(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.ByteBuffer, int, org.javaavc.ffmpeg.avdevice.AVSubtitle)} and {@link #avcodec_encode_subtitle(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.Pointer, int, org.javaavc.ffmpeg.avdevice.AVSubtitle)} instead
	 */
	@Deprecated 
	...
	LibavdeviceLibrary.AVResampleContext av_resample_init(int out_rate, int in_rate, int filter_length, int log2_phase_count, int linear, double cutoff);
	/**
	 * Original signature : <code>int av_resample(AVResampleContext*, short*, short*, int*, int, int, int)</code><br>
	 * @deprecated use the safer methods {@link #av_resample(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.AVResampleContext, java.nio.ShortBuffer, java.nio.ShortBuffer, java.nio.IntBuffer, int, int, int)} and {@link #av_resample(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.AVResampleContext, com.sun.jna.ptr.ShortByReference, com.sun.jna.ptr.ShortByReference, com.sun.jna.ptr.IntByReference, int, int, int)} instead
	 */
	@Deprecated 
	int av_resample(LibavdeviceLibrary.AVResampleContext c, ShortByReference dst, ShortByReference src, IntByReference consumed, int src_size, int dst_size, int update_ctx);
	/** Original signature : <code>int av_resample(AVResampleContext*, short*, short*, int*, int, int, int)</code> */
	int av_resample(LibavdeviceLibrary.AVResampleContext c, ShortBuffer dst, ShortBuffer src, IntBuffer consumed, int src_size, int dst_size, int update_ctx);
	/** Original signature : <code>void av_resample_compensate(AVResampleContext*, int, int)</code> */
	void av_resample_compensate(LibavdeviceLibrary.AVResampleContext c, int sample_delta, int compensation_distance);
	/** Original signature : <code>void av_resample_close(AVResampleContext*)</code> */
	void av_resample_close(LibavdeviceLibrary.AVResampleContext c);
	/**
	 ...
	 * @deprecated use the safer methods {@link #avpicture_fill(org.javaavc.ffmpeg.avdevice.AVPicture, java.nio.ByteBuffer, int, int, int)} and {@link #avpicture_fill(org.javaavc.ffmpeg.avdevice.AVPicture, com.sun.jna.Pointer, int, int, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avpicture_layout(org.javaavc.ffmpeg.avdevice.AVPicture, int, int, int, java.nio.ByteBuffer, int)} and {@link #avpicture_layout(org.javaavc.ffmpeg.avdevice.AVPicture, int, int, int, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_picture_pad(org.javaavc.ffmpeg.avdevice.AVPicture, org.javaavc.ffmpeg.avdevice.AVPicture, int, int, int, int, int, int, int, java.nio.IntBuffer)} and {@link #av_picture_pad(org.javaavc.ffmpeg.avdevice.AVPicture, org.javaavc.ffmpeg.avdevice.AVPicture, int, int, int, int, int, int, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_default_get_format(org.javaavc.ffmpeg.avdevice.AVCodecContext, java.nio.IntBuffer)} and {@link #avcodec_default_get_format(org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_get_codec_tag_string(java.nio.ByteBuffer, org.javaavc.NativeSize, int)} and {@link #av_get_codec_tag_string(com.sun.jna.Pointer, org.javaavc.NativeSize, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_string(java.nio.ByteBuffer, int, org.javaavc.ffmpeg.avdevice.AVCodecContext, int)} and {@link #avcodec_string(com.sun.jna.Pointer, int, org.javaavc.ffmpeg.avdevice.AVCodecContext, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avcodec_default_execute(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avcodec_default_execute_func_callback, com.sun.jna.Pointer, java.nio.IntBuffer, int, int)} and {@link #avcodec_default_execute(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avcodec_default_execute_func_callback, com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference, int, int)} instead
	 */
	@Deprecated 
	int avcodec_default_execute(AVCodecContext c, LibavdeviceLibrary.avcodec_default_execute_func_callback func, Pointer arg, IntByReference ret, int count, int size);
	...
	int avcodec_default_execute(AVCodecContext c, LibavdeviceLibrary.avcodec_default_execute_func_callback func, Pointer arg, IntBuffer ret, int count, int size);
	/**
	 ...
	 * @deprecated use the safer methods {@link #avcodec_default_execute2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avcodec_default_execute2_func_callback, com.sun.jna.Pointer, java.nio.IntBuffer, int)} and {@link #avcodec_default_execute2(org.javaavc.ffmpeg.avdevice.AVCodecContext, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avcodec_default_execute2_func_callback, com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference, int)} instead
	 */
	@Deprecated 
	int avcodec_default_execute2(AVCodecContext c, LibavdeviceLibrary.avcodec_default_execute2_func_callback func, Pointer arg, IntByReference ret, int count);
	...
	int avcodec_default_execute2(AVCodecContext c, LibavdeviceLibrary.avcodec_default_execute2_func_callback func, Pointer arg, IntBuffer ret, int count);
	/**
	 ...
	 * @deprecated use the safer methods {@link #avcodec_fill_audio_frame(org.javaavc.ffmpeg.avdevice.AVFrame, int, int, java.nio.ByteBuffer, int, int)} and {@link #avcodec_fill_audio_frame(org.javaavc.ffmpeg.avdevice.AVFrame, int, int, com.sun.jna.Pointer, int, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_bitstream_filter_filter(org.javaavc.ffmpeg.avdevice.AVBitStreamFilterContext, org.javaavc.ffmpeg.avdevice.AVCodecContext, java.lang.String, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, java.nio.ByteBuffer, int, int)} and {@link #av_bitstream_filter_filter(org.javaavc.ffmpeg.avdevice.AVBitStreamFilterContext, org.javaavc.ffmpeg.avdevice.AVCodecContext, com.sun.jna.Pointer, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.Pointer, int, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_fast_realloc(com.sun.jna.Pointer, java.nio.IntBuffer, org.javaavc.NativeSize)} and {@link #av_fast_realloc(com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference, org.javaavc.NativeSize)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_fast_malloc(com.sun.jna.Pointer, java.nio.IntBuffer, org.javaavc.NativeSize)} and {@link #av_fast_malloc(com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference, org.javaavc.NativeSize)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_fast_padded_malloc(com.sun.jna.Pointer, java.nio.IntBuffer, org.javaavc.NativeSize)} and {@link #av_fast_padded_malloc(com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference, org.javaavc.NativeSize)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_fast_padded_mallocz(com.sun.jna.Pointer, java.nio.IntBuffer, org.javaavc.NativeSize)} and {@link #av_fast_padded_mallocz(com.sun.jna.Pointer, com.sun.jna.ptr.IntByReference, org.javaavc.NativeSize)} instead
	 */
	@Deprecated 
	 ...
	 */
	int av_lockmgr_register(LibavdeviceLibrary.av_lockmgr_register_cb_callback cb);
	/**
	 ...
	 * @deprecated use the safer methods {@link #avio_alloc_context(java.nio.ByteBuffer, int, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avio_alloc_context_read_packet_callback, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avio_alloc_context_write_packet_callback, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avio_alloc_context_seek_callback)} and {@link #avio_alloc_context(com.sun.jna.Pointer, int, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avio_alloc_context_read_packet_callback, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avio_alloc_context_write_packet_callback, org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.avio_alloc_context_seek_callback)} instead
	 */
	@Deprecated 
	AVIOContext avio_alloc_context(Pointer buffer, int buffer_size, int write_flag, Pointer opaque, LibavdeviceLibrary.avio_alloc_context_read_packet_callback read_packet, LibavdeviceLibrary.avio_alloc_context_write_packet_callback write_packet, LibavdeviceLibrary.avio_alloc_context_seek_callback seek);
	/**
	 * Allocate and initialize an AVIOContext for buffered I/O. It must be later<br>
	 * freed with av_free().<br>
	 * * @param buffer Memory block for input/output operations via AVIOContext.<br>
	 ...
	 */
	AVIOContext avio_alloc_context(ByteBuffer buffer, int buffer_size, int write_flag, Pointer opaque, LibavdeviceLibrary.avio_alloc_context_read_packet_callback read_packet, LibavdeviceLibrary.avio_alloc_context_write_packet_callback write_packet, LibavdeviceLibrary.avio_alloc_context_seek_callback seek);
	 ...
	 * @deprecated use the safer methods {@link #avio_write(org.javaavc.ffmpeg.avdevice.AVIOContext, java.nio.ByteBuffer, int)} and {@link #avio_write(org.javaavc.ffmpeg.avdevice.AVIOContext, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_put_str(org.javaavc.ffmpeg.avdevice.AVIOContext, java.lang.String)} and {@link #avio_put_str(org.javaavc.ffmpeg.avdevice.AVIOContext, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_put_str16le(org.javaavc.ffmpeg.avdevice.AVIOContext, java.lang.String)} and {@link #avio_put_str16le(org.javaavc.ffmpeg.avdevice.AVIOContext, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_printf(org.javaavc.ffmpeg.avdevice.AVIOContext, java.lang.String, java.lang.Object)} and {@link #avio_printf(org.javaavc.ffmpeg.avdevice.AVIOContext, com.sun.jna.Pointer, java.lang.Object)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_read(org.javaavc.ffmpeg.avdevice.AVIOContext, java.nio.ByteBuffer, int)} and {@link #avio_read(org.javaavc.ffmpeg.avdevice.AVIOContext, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_get_str(org.javaavc.ffmpeg.avdevice.AVIOContext, int, java.nio.ByteBuffer, int)} and {@link #avio_get_str(org.javaavc.ffmpeg.avdevice.AVIOContext, int, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_get_str16le(org.javaavc.ffmpeg.avdevice.AVIOContext, int, java.nio.ByteBuffer, int)} and {@link #avio_get_str16le(org.javaavc.ffmpeg.avdevice.AVIOContext, int, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_get_str16be(org.javaavc.ffmpeg.avdevice.AVIOContext, int, java.nio.ByteBuffer, int)} and {@link #avio_get_str16be(org.javaavc.ffmpeg.avdevice.AVIOContext, int, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_open(org.javaavc.ffmpeg.avdevice.AVIOContext.ByReference[], java.lang.String, int)} and {@link #avio_open(org.javaavc.ffmpeg.avdevice.AVIOContext.ByReference[], com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avio_open2(org.javaavc.ffmpeg.avdevice.AVIOContext.ByReference[], java.lang.String, int, org.javaavc.ffmpeg.avdevice.AVIOInterruptCB, com.sun.jna.ptr.PointerByReference)} and {@link #avio_open2(org.javaavc.ffmpeg.avdevice.AVIOContext.ByReference[], com.sun.jna.Pointer, int, org.javaavc.ffmpeg.avdevice.AVIOInterruptCB, com.sun.jna.ptr.PointerByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #avio_closep(org.javaavc.ffmpeg.avdevice.AVIOContext.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #avio_open_dyn_buf(org.javaavc.ffmpeg.avdevice.AVIOContext.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avformat_alloc_output_context(java.lang.String, org.javaavc.ffmpeg.avdevice.AVOutputFormat, java.lang.String)} and {@link #avformat_alloc_output_context(com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.AVOutputFormat, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avformat_alloc_output_context2(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[], org.javaavc.ffmpeg.avdevice.AVOutputFormat, java.lang.String, java.lang.String)} and {@link #avformat_alloc_output_context2(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[], org.javaavc.ffmpeg.avdevice.AVOutputFormat, com.sun.jna.Pointer, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_probe_input_format2(org.javaavc.ffmpeg.avdevice.AVProbeData, int, java.nio.IntBuffer)} and {@link #av_probe_input_format2(org.javaavc.ffmpeg.avdevice.AVProbeData, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_probe_input_format3(org.javaavc.ffmpeg.avdevice.AVProbeData, int, java.nio.IntBuffer)} and {@link #av_probe_input_format3(org.javaavc.ffmpeg.avdevice.AVProbeData, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_probe_input_buffer(org.javaavc.ffmpeg.avdevice.AVIOContext, org.javaavc.ffmpeg.avdevice.AVInputFormat.ByReference[], java.lang.String, com.sun.jna.Pointer, int, int)} and {@link #av_probe_input_buffer(org.javaavc.ffmpeg.avdevice.AVIOContext, org.javaavc.ffmpeg.avdevice.AVInputFormat.ByReference[], com.sun.jna.Pointer, com.sun.jna.Pointer, int, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #avformat_open_input(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[], java.lang.String, org.javaavc.ffmpeg.avdevice.AVInputFormat, com.sun.jna.ptr.PointerByReference)} and {@link #avformat_open_input(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[], com.sun.jna.Pointer, org.javaavc.ffmpeg.avdevice.AVInputFormat, com.sun.jna.ptr.PointerByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_find_best_stream(org.javaavc.ffmpeg.avdevice.AVFormatContext, int, int, int, org.javaavc.ffmpeg.avdevice.AVCodec.ByReference[], int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #avformat_close_input(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_guess_codec(org.javaavc.ffmpeg.avdevice.AVOutputFormat, java.lang.String, java.lang.String, java.lang.String, int)} and {@link #av_guess_codec(org.javaavc.ffmpeg.avdevice.AVOutputFormat, com.sun.jna.Pointer, com.sun.jna.Pointer, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_get_output_timestamp(org.javaavc.ffmpeg.avdevice.AVFormatContext, int, java.nio.LongBuffer, java.nio.LongBuffer)} and {@link #av_get_output_timestamp(org.javaavc.ffmpeg.avdevice.AVFormatContext, int, com.sun.jna.ptr.LongByReference, com.sun.jna.ptr.LongByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_hex_dump(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.FILE, java.nio.ByteBuffer, int)} and {@link #av_hex_dump(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.FILE, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	void av_hex_dump(LibavdeviceLibrary.FILE f, Pointer buf, int size);
	/**
	 * Send a nice hexadecimal dump of a buffer to the specified file stream.<br>
	 * * @param f The file stream pointer where the dump should be sent to.<br>
	 * @param buf buffer<br>
	 ...
	 */
	void av_hex_dump(LibavdeviceLibrary.FILE f, ByteBuffer buf, int size);
	/**
	 ...
	 */
	void av_pkt_dump2(LibavdeviceLibrary.FILE f, AVPacket pkt, int dump_payload, AVStream st);
	/**
	 ...
	 * @deprecated use the safer method {@link #av_codec_get_id(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.AVCodecTag[], int)} instead
	 */
	@Deprecated 
	 ...
	 */
	int av_codec_get_id(LibavdeviceLibrary.AVCodecTag tags[], int tag);
	/**
	 ...
	 * @deprecated use the safer method {@link #av_codec_get_tag(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.AVCodecTag[], int)} instead
	 */
	@Deprecated 
	 ...
	 */
	int av_codec_get_tag(LibavdeviceLibrary.AVCodecTag tags[], int id);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_codec_get_tag2(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.AVCodecTag[], int, java.nio.IntBuffer)} and {@link #av_codec_get_tag2(org.javaavc.ffmpeg.avdevice.LibavdeviceLibrary.AVCodecTag[], int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 */
	int av_codec_get_tag2(LibavdeviceLibrary.AVCodecTag tags[], int id, IntBuffer tag);
	/**
	 * Get the codec tag for the given codec id.<br>
	 * * @param tags list of supported codec_id - codec_tag pairs, as stored<br>
	 * in AVInputFormat.codec_tag and AVOutputFormat.codec_tag<br>
	 ...
	 * Original signature : <code>int av_codec_get_tag2(const AVCodecTag**, AVCodecID, unsigned int*)</code>
	 */
	int av_codec_get_tag2(LibavdeviceLibrary.AVCodecTag tags[], int id, IntByReference tag);
	 ...
	 * @deprecated use the safer methods {@link #av_dump_format(org.javaavc.ffmpeg.avdevice.AVFormatContext, int, java.lang.String, int)} and {@link #av_dump_format(org.javaavc.ffmpeg.avdevice.AVFormatContext, int, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_sdp_create(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[], int, java.nio.ByteBuffer, int)} and {@link #av_sdp_create(org.javaavc.ffmpeg.avdevice.AVFormatContext.ByReference[], int, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 */
	LibavdeviceLibrary.AVCodecTag avformat_get_riff_video_tags();
	/**
	 ...
	 */
	LibavdeviceLibrary.AVCodecTag avformat_get_riff_audio_tags();
	/**
	 ...
	 * @deprecated use the safer methods {@link #avformat_match_stream_specifier(org.javaavc.ffmpeg.avdevice.AVFormatContext, org.javaavc.ffmpeg.avdevice.AVStream, java.lang.String)} and {@link #avformat_match_stream_specifier(org.javaavc.ffmpeg.avdevice.AVFormatContext, org.javaavc.ffmpeg.avdevice.AVStream, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
