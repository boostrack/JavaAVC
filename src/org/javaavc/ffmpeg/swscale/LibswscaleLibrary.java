...
public interface LibswscaleLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #av_rescale_delta(org.javaavc.ffmpeg.swscale.AVRational.ByValue, long, org.javaavc.ffmpeg.swscale.AVRational.ByValue, int, java.nio.LongBuffer, org.javaavc.ffmpeg.swscale.AVRational.ByValue)} and {@link #av_rescale_delta(org.javaavc.ffmpeg.swscale.AVRational.ByValue, long, org.javaavc.ffmpeg.swscale.AVRational.ByValue, int, com.sun.jna.ptr.LongByReference, org.javaavc.ffmpeg.swscale.AVRational.ByValue)} instead
	 */
	@Deprecated 
	...
	double av_ext2dbl(org.javaavc.ffmpeg.swscale.AVExtFloat.ByValue ext);
	...
	org.javaavc.ffmpeg.swscale.AVExtFloat.ByValue av_dbl2ext(double d);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_vlog(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.swscale.LibswscaleLibrary.va_list)} and {@link #av_vlog(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.swscale.LibswscaleLibrary.va_list)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_log_default_callback(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.swscale.LibswscaleLibrary.va_list)} and {@link #av_log_default_callback(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.swscale.LibswscaleLibrary.va_list)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_log_format_line(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.swscale.LibswscaleLibrary.va_list, java.nio.ByteBuffer, int, java.nio.IntBuffer)} and {@link #av_log_format_line(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.swscale.LibswscaleLibrary.va_list, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
