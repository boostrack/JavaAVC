...
public interface LibavfilterLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #av_rescale_delta(org.javaavc.ffmpeg.avfilter.AVRational.ByValue, long, org.javaavc.ffmpeg.avfilter.AVRational.ByValue, int, java.nio.LongBuffer, org.javaavc.ffmpeg.avfilter.AVRational.ByValue)} and {@link #av_rescale_delta(org.javaavc.ffmpeg.avfilter.AVRational.ByValue, long, org.javaavc.ffmpeg.avfilter.AVRational.ByValue, int, com.sun.jna.ptr.LongByReference, org.javaavc.ffmpeg.avfilter.AVRational.ByValue)} instead
	 */
	@Deprecated 
	...
	double av_ext2dbl(org.javaavc.ffmpeg.avfilter.AVExtFloat.ByValue ext);
	...
	org.javaavc.ffmpeg.avfilter.AVExtFloat.ByValue av_dbl2ext(double d);
	/**
	 ...
	 * @deprecated use the safer methods {@link #av_vlog(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.va_list)} and {@link #av_vlog(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.va_list)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_log_default_callback(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.va_list)} and {@link #av_log_default_callback(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.va_list)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_log_format_line(com.sun.jna.Pointer, int, java.lang.String, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.va_list, java.nio.ByteBuffer, int, java.nio.IntBuffer)} and {@link #av_log_format_line(com.sun.jna.Pointer, int, com.sun.jna.Pointer, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.va_list, com.sun.jna.Pointer, int, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_dict_get(com.sun.jna.ptr.PointerByReference, java.lang.String, org.javaavc.ffmpeg.avfilter.AVDictionaryEntry, int)} and {@link #av_dict_get(com.sun.jna.ptr.PointerByReference, com.sun.jna.Pointer, org.javaavc.ffmpeg.avfilter.AVDictionaryEntry, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_buffer_create(java.nio.ByteBuffer, int, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.av_buffer_create_free_callback, com.sun.jna.Pointer, int)} and {@link #av_buffer_create(com.sun.jna.Pointer, int, org.javaavc.ffmpeg.avfilter.LibavfilterLibrary.av_buffer_create_free_callback, com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_unref(org.javaavc.ffmpeg.avfilter.AVBufferRef.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_make_writable(org.javaavc.ffmpeg.avfilter.AVBufferRef.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_buffer_realloc(org.javaavc.ffmpeg.avfilter.AVBufferRef.ByReference[], int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_frame_set_metadata(org.javaavc.ffmpeg.avfilter.AVFrame, com.sun.jna.ptr.PointerByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #av_frame_get_qp_table(org.javaavc.ffmpeg.avfilter.AVFrame, java.nio.IntBuffer, java.nio.IntBuffer)} and {@link #av_frame_get_qp_table(org.javaavc.ffmpeg.avfilter.AVFrame, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer method {@link #av_frame_free(org.javaavc.ffmpeg.avfilter.AVFrame.ByReference[])} instead
	 */
	@Deprecated 
